...
//                    }
        ...
        fun ensureSockopt(): XrayConfig.OutboundBean.StreamSettingsBean.SockoptBean {
            val stream = streamSettings ?: XrayConfig.OutboundBean.StreamSettingsBean().also {
                streamSettings = it
            }

            val sockopt = stream.sockopt ?: XrayConfig.OutboundBean.StreamSettingsBean.SockoptBean().also {
                stream.sockopt = it
            }
